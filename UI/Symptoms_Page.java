...
public class Symptoms_Page extends javax.swing.JFrame {
    ...
    int[] id1 = {0,0,0,0,0};
    int[] intensity1 = new int[5];
    int[] id2 = {0,0,0,0,0};
    int[] intensity2 = new int[5];
    int no_of_used_symptoms = 0;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(jCheckBox1.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom1 where description = '" + jTextField1.getText() + "' and bodypart = '" + jComboBox1.getSelectedItem() + "'", stmt);            
            try {
                if(rs.next()){
                    id1[0] = rs.getInt("id");
                    intensity1[0] = jSlider1.getValue();
                }
            }
            catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        if(jCheckBox2.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom1 where description = '" + jTextField2.getText() + "' and bodypart = '" + jComboBox2.getSelectedItem() + "'", stmt);
            try{
                if(rs.next()){
                    id1[1] = rs.getInt("id");
                    intensity1[1] = jSlider2.getValue();
                }
            }
            catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if(jCheckBox3.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom1 where description = '" + jTextField3.getText() + "' and bodypart = '" + jComboBox3.getSelectedItem() + "'", stmt);
            try {
                if(rs.next()){
                    id1[2] = rs.getInt("id");
                    intensity1[2] = jSlider3.getValue();
                }
            } catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(jCheckBox4.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom1 where description = '" + jTextField4.getText() + "' and bodypart = '" + jComboBox4.getSelectedItem() + "'", stmt);
            try {
                if(rs.next()){
                    id1[3] = rs.getInt("id");
                    intensity1[3] = jSlider4.getValue();
                }
            } catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(jCheckBox5.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom1 where description = '" + jTextField5.getText() + "' and bodypart = '" + jComboBox5.getSelectedItem() + "'", stmt);
            try {
                if(rs.next()){
                id1[4] = rs.getInt("id");
                intensity1[4] = jSlider5.getValue();
                }
            } catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(jCheckBox6.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom2 where description = '" + jTextField6.getText() + "'", stmt);
            try {
                if(rs.next()){
                id2[0] = rs.getInt("id");
                intensity2[0] = jSlider6.getValue();
                }
            } catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(jCheckBox7.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom2 where description = '" + jTextField7.getText() + "'", stmt);
            try {
                if(rs.next()){
                id2[1] = rs.getInt("id");
                intensity2[1] = jSlider7.getValue();
                }
            } catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(jCheckBox8.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom2 where description = '" + jTextField8.getText() + "'", stmt);
            try {
                if(rs.next()){
                id2[2] = rs.getInt("id");
                intensity2[2] = jSlider8.getValue();
                }
            } catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(jCheckBox9.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom2 where description = '" + jTextField9.getText() + "'", stmt);
            try {
                if(rs.next()){
                id2[3] = rs.getInt("id");
                intensity2[3] = jSlider9.getValue();
                }
            } catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(jCheckBox10.isSelected()){
            ...
            rs = db.getRS("select id from mades.symptom2 where description = '" + jTextField10.getText() + "'", stmt);
            try {
                if(rs.next()){
                id2[4] = rs.getInt("id");intensity2[4] = jSlider10.getValue();}
            } catch (SQLException ex) {
                Logger.getLogger(Symptoms_Page.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(count == 0){    
            ...
            Diagnosis_Page dp = new Diagnosis_Page(id1,id2,intensity1,intensity2,no_of_used_symptoms);//send intensity and ids forward
            dp.setVisible(true);
        }
        else{
